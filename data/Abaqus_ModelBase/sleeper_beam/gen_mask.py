...
def get_multimask(class_num, h, w, n=8, min_area_rate=0.2, max_area_rate=0.9, 
...
def get_mask(h, w, n=8, min_area_rate=0.2, max_area_rate=0.9, spot_num=80, max_R=5, min_R=1, thresh=0.5, win_size=5):
